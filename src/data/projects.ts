...
export const projectSeedData: NewProjectPayload[] = [
  {
  ...
  },
  {
    ...
    description: "My implementation of C compiler written in Swift",
    tech: ["Swift"],
    links: [{ label: "GitHub", href: "https://github.com/annurdien/bcc" }],
    category: "Compiler",
    year: 2025,
    status: "Shipped",
    featured: false,
  ...
  },
  {
    ...
    tech: ["C++"],
    links: [{ label: "GitHub", href: "https://github.com/annurdien/chip8" }],
    category: "Emulator",
    year: 2025,
    status: "Shipped",
    featured: false,
  ...
  },
  {
    ...
    tech: ["Swift"],
    links: [{ label: "GitHub", href: "https://github.com/annurdien/Toasty" }],
    category: "Library",
    year: 2025,
    status: "Shipped",
    featured: false,
  ...
  },
  {
    ...
    links: [
      {
        label: "GitHub",
        href: "https://github.com/annurdien/flutter_clean_architecture",
      },
    ],
    category: "Library",
    year: 2025,
  ...
  },
  {
    ...
    tech: ["Swift"],
    links: [{ label: "GitHub", href: "https://github.com/annurdien/populate" }],
    category: "Library",
    year: 2025,
    status: "Shipped",
    featured: false,
  ...
  },
  {
    ...
    tech: ["Go"],
    links: [{ label: "GitHub", href: "https://github.com/annurdien/sim-cli" }],
    category: "Tools",
    year: 2025,
    status: "Shipped",
    featured: false,
  ...
  },
  {
    ...
    tech: ["TypeScript"],
    links: [{ label: "GitHub", href: "https://github.com/annurdien/sigma" }],
    category: "Tools",
    year: 2025,
    status: "Shipped",
    featured: false,
  ...
  },
  {
    ...
    tech: ["Rust"],
    links: [{ label: "GitHub", href: "https://github.com/annurdien/http-rust" }],
    category: "Library",
    year: 2025,
    status: "Shipped",
    featured: false,
  ...
  },
  {
    ...
    tech: ["Swift"],
    links: [{ label: "GitHub", href: "https://github.com/annurdien/Wing" }],
    category: "Library",
    year: 2025,
    status: "Shipped",
    featured: false,
  ...
  },
  {
    ...
    tech: ["Swift"],
    links: [{ label: "GitHub", href: "https://github.com/annurdien/WhatSnap" }],
    category: "iOS App",
    year: 2025,
    status: "Shipped",
    featured: false,
  ...
  },
  {
    ...
    tech: ["Swift"],
    links: [{ label: "GitHub", href: "https://github.com/annurdien/pes-joke" }],
    category: "iOS App",
    year: 2025,
    status: "Shipped",
    featured: false,
  ...
  },
  {
    ...
    links: [
      {
        label: "GitHub",
        href: "https://github.com/annurdien/cloudflare-r2-with-stream",
      },
    ],
    category: "Library",
    year: 2025,
  ...
  },
  {
    ...
    tech: ["TypeScript"],
    links: [{ label: "GitHub", href: "https://github.com/annurdien/IDLIX-API" }],
    category: "Library",
    year: 2025,
    status: "Shipped",
    featured: false,
  ...
  },
  {
    ...
    description: "Meme project, Rust programming syntax in Indonesian language",
    tech: ["Rust"],
    links: [{ label: "GitHub", href: "https://github.com/annurdien/karat" }],
    category: "Compiler",
    year: 2025,
    status: "Shipped",
    featured: false,
  ...
  },
  {
    ...
    tech: ["C++"],
    links: [{ label: "GitHub", href: "https://github.com/annurdien/MPILOT" }],
    category: "Tools",
    year: 2025,
    status: "Shipped",
    featured: false,
